...
<head>
    ...
    <title>Jobnest | Candidat List</title>
                    ...
                    <div class="wt-bnr-inr-entry">
                        <div class="banner-title-outer">
                            <div class="banner-title-name">
                                <h2 class="wt-title">Daftar Kandidat Pelamar</h2>
                            </div>
                        </div>
                        <!-- BREADCRUMB ROW -->
                    ...
                    <div class="row">
                            ...
                            <div class="side-bar-st-1">
                                ...
                                <div class="twm-nav-list-1">
                                    <ul>
                                        ...
                                        <li class="active"><a href="candidate-grid.html"><i class="fa fa-user-check"></i> Browse Candidates</a></li>
                        ...
                        <div class="col-lg-9 col-md-12">
                            ...
                            <div class="product-filter-wrap d-flex justify-content-between align-items-center m-b30">
                                <span class="woocommerce-result-count-left">Showing {{$countKandidat}} Candidates</span>
                            ...
                            <div class="twm-candidates-grid-wrap">
                                <div class="row">
                                    @foreach ($getKandidat as $kandidat )
                                    <div class="col-lg-6 col-md-6">
                                        <div class="twm-candidates-grid-style1 mb-5">
                                            <div class="twm-media">
                                                <div class="twm-media-pic">
                                                   <img src="{{asset('jobnest')}}/images/candidates/pic1.jpg" alt="#">
                                                </div>
                                                <div class="twm-candidates-tag"><span>Featured</span></div>
                                            </div>
                                            <div class="twm-mid-content">
                                                <a href="candidate-detail.html" class="twm-job-title">
                                                    <h4>{{$kandidat->user->name}}</h4>
                                                </a>
                                                <p>{{$kandidat->job->job}}</p>
                                                <a href="/detailKandidat/{{$kandidat->id_user}}" class="twm-view-prifile site-text-primary">View Profile</a>

                                                <div class="twm-fot-content">
                                                    <div class="twm-left-info">
                                                       <p class="twm-candidate-address"><i class="feather-mail"></i>{{$kandidat->user->email}}</p>
                                                    </div>
                                               </div>
                                            </div>
