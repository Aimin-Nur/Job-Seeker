...
<head>
    ...
    <title>Jobnest | Company Profile</title>
                            ...
                            <div class="side-bar-st-1">
                                ...
                                <div class="twm-nav-list-1">
                                    <ul>
                                        ...
                                        <li><a href="/joblist/{id}"><i class="fa fa-suitcase"></i> Manage Jobs</a></li>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="ls-inputicon-box">
                                                                <input class="form-control" value="{{$company->nama_company}}" name="company_name" type="text" placeholder="Devid Smith">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <label>Contact</label>
                                                            <div class="ls-inputicon-box">
                                                                <input class="form-control" value="{{$company->nomor_hp}}" name="company_phone" type="text" placeholder="(251) 1234-456-7890">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="ls-inputicon-box">
                                                                <input class="form-control" value="{{$company->email}}" name="company_Email" type="email" placeholder="Devid@example.com">
                                                    ...
                                                    <div class="col-xl-6 col-lg-6 col-md-12">
                                                        <div class="form-group">
                                                            <label>Website</label>
                                                            <div class="ls-inputicon-box">
                                                                <input class="form-control" value="{{$company->website}}" name="company_website" type="text" placeholder="https://devsmith.net/">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                                        <div class="form-group city-outer-bx has-feedback">
                                                            ...
                                                            <div class="ls-inputicon-box">
                                                                <input class="form-control" value="{{$company->lokasi}}" name="company_since" type="text" placeholder="1363-1385 Sunset Blvd Angeles, CA 90026 ,USA">
                                                    ...
                                                    <div class="col-xl-12 col-lg-12 col-md-12">
                                                        <div class="twm-s-map mb-5">
                                                            ...
                                                            <div class="twm-s-map-iframe">
                                                                <iframe height=270 src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3973.7163059751756!2d119.41509819999997!3d-5.1492898999999985!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dbf1d5f37736393%3A0x6868a8c18f762483!2sWisma%20Kalla!5e0!3m2!1sid!2sid!4v1705757243203!5m2!1sid!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="3">{{$company->deskripsi ?? 'lorem ipsum sorem lorem dan ispsum lorem sorem supim'}}</textarea>
                                                        </div>
                                                    </div>
