     ...
     <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img class="navbar-brand-image" src="{{asset('landingPage')}}/assets/img/logo/logo.png" alt="">
            </a>
          </h1>
      ...
      <header class="navbar-expand-md">
        <div class="collapse navbar-collapse" id="navbar-menu">
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                <li class="nav-item {{ request()->is('dahboardAdmin') ? 'active' : '' }}">
                  <a class="nav-link" href="/dashbaordAdmin" >
                ...
                <li class="nav-item {{ request()->is('adminJob') ? 'active' : '' }}">
                  <a class="nav-link" href="/adminJob" >
                ...
                <li class="nav-item {{ request()->is('listEmploye') ? 'active' : '' }}">
                  <a class="nav-link" href="/listEmploye">
