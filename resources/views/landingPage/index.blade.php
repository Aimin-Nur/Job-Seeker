                    ...
                    <div class="twm-bnr-right-content">
                        ...
                        <div class="twm-bnr-right-carousel">
                            <div class="owl-carousel twm-h1-bnr-carousal">
                                <div class="item">
                                  <div class="slide-img">
                                    <img src="{{asset('jobnest')}}/images/main-slider/slider1/r-img1.png" alt="#">
                                  </div>
                                </div>
                                <div class="item">
                                  <div class="slide-img">
                                    <div class="slide-img">
                                        <img src="{{asset('jobnest')}}/images/main-slider/slider1/r-img2.png" alt="#">
                                      </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="twm-bnr-blocks-position-wrap">
                                ...
                                <div class="twm-bnr-blocks twm-bnr-blocks-position-1">
                                    <div class="twm-icon">
                                        <img src="{{asset('jobnest')}}/images/main-slider/slider1/icon-1.png" alt="">
                                    </div>
                                ...
                                <div class="twm-bnr-blocks twm-bnr-blocks-position-2">
                                    <div class="twm-icon">
                                        <img src="{{asset('jobnest')}}/images/main-slider/slider1/icon-2.png" alt="">
                                    </div>
                                    <div class="twm-content">
                                ...
                                <div class="twm-bnr-blocks-3 twm-bnr-blocks-position-3">
                                    <div class="twm-pics">
                                        <span><img src="{{asset('jobnest')}}/images/main-slider/slider1/user/u-1.jpg" alt=""></span>
                                        <span><img src="{{asset('jobnest')}}/images/main-slider/slider1/user/u-2.jpg" alt=""></span>
                                        <span><img src="{{asset('jobnest')}}/images/main-slider/slider1/user/u-3.jpg" alt=""></span>
                                        <span><img src="{{asset('jobnest')}}/images/main-slider/slider1/user/u-4.jpg" alt=""></span>
                                        <span><img src="{{asset('jobnest')}}/images/main-slider/slider1/user/u-5.jpg" alt=""></span>
                                        <span><img src="{{asset('jobnest')}}/images/main-slider/slider1/user/u-6.jpg" alt=""></span>
                                    </div>
                                    <div class="twm-content">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="twm-w-process-steps">
                                ...
                                <div class="twm-w-pro-top bg-clr-sky">
                                    <div class="twm-media">
                                        <span><img src="{{asset('jobnest')}}/images/work-process/icon1.png" alt="icon1"></span>
                                    </div>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            <div class="twm-w-process-steps">
                                ...
                                <div class="twm-w-pro-top bg-clr-green">
                                    <div class="twm-media">
                                        <span><img src="{{asset('jobnest')}}/images/work-process/icon3.png" alt="icon1"></span>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="twm-explore-media-wrap">
                                <div class="twm-media">
                                    <img src="{{asset('jobnest')}}/images/gir-large.png" alt="">
                                </div>
                            </div>
                        </div>
                       ...
                       <ul>
                            ...
                            <li>
                                <div class="twm-jobs-list-style1 mb-5">
                                    <div class="twm-media">
                                        <img src="{{ asset('landingPage/assets/img/icon/' . $job->logo_company) }}">
                                    </div>
                                    <div class="twm-mid-content">
                                        <a href="job-detail.html" class="twm-job-title">
                                            <h4>{{$job->job}}<span class="twm-job-post-duration">/ {{$job->tersedia}} tersedia</span></h4>
                                        </a>
                                        <p class="twm-job-address">{{$job->lokasi}}</p>
                                    ...
                                    <div class="twm-right-content">
                                        <div class="twm-jobs-category green"><span class="twm-bg-green">{{$job->kategori}}</span></div>
                                        <div class="col-lg-12 twm-jobs-amount">{{$job->gaji}}<small class="text-success">/Month</small></div>
                                        <a href="/detailJob/{{$job->id}}" class="twm-jobs-browse site-text-primary">Browse Job</a>
                                    </div>
                                </div>
                            </li>
                            @endforeach
                    ...
                    <div class="owl-carousel twm-testimonial-1-carousel owl-btn-bottom-center ">
                            ...
                            <div class="twm-testimonial-1">
                                <div class="twm-testimonial-1-content">
                                    <div class="twm-testi-media">
                                        <img src="{{asset('jobnest')}}/images/testimonials/pic-1.png" alt="#">
                                    </div>
                        ...
                        <div class="item ">
                            <div class="twm-testimonial-1">
                                <div class="twm-testimonial-1-content">
                                    <div class="twm-testi-media">
                                        <img src="{{asset('jobnest')}}/images/testimonials/pic-2.png" alt="#">
                                    </div>
                                    <div class="twm-testi-content">
                                        <div class="twm-quote">
                                            <img src="images/quote-dark.png" alt="">
                        ...
                        <div class="item ">
                            <div class="twm-testimonial-1">
                                <div class="twm-testimonial-1-content">
                                    <div class="twm-testi-media">
                                        <img src="{{asset('jobnest')}}/images/testimonials/pic-3.png" alt="#">
                                    </div>
                                    <div class="twm-testi-content">
                                        <div class="twm-quote">
                                            <img src="images/quote-dark.png" alt="">
                        ...
                        <div class="item ">
                            <div class="twm-testimonial-1">
                                <div class="twm-testimonial-1-content">
                                    ...
                                    <div class="twm-testi-content">
                                        <div class="twm-quote">
                                            <img src="{{asset('jobnest')}}/images/quote-dark.png" alt="">
                                        </div>
                                        <div class="twm-testi-info">I just got a job that I applied for via careerfy! I used the site all the time during my job hunt.</div>
                                        <div class="twm-testi-detail">
                                            <div class="twm-testi-name">Nikola Tesla</div>
                    ...
                    <div class="twm-blog-post-1-outer-wrap">
                        <div class="owl-carousel twm-la-home-blog owl-btn-bottom-center">
                            <div class="item">
                                ...
                                <div class="blog-post twm-blog-post-1-outer">
                                    <div class="wt-post-media">
                                        <a href="blog-single.html"><img src="{{asset('jobnest')}}/images/blog/latest/bg1.jpg" alt=""></a>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="blog-post twm-blog-post-1-outer">
                                    <div class="wt-post-media">
                                        <a href="blog-single.html"><img src="{{asset('jobnest')}}/images/blog/latest/bg2.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-meta ">
                                            <ul>
                            ...
                            <div class="item">
                                ...
                                <div class="blog-post twm-blog-post-1-outer">
                                    <div class="wt-post-media">
                                        <a href="blog-single.html"><img src="{{asset('jobnest')}}/images/blog/latest/bg3.jpg" alt=""></a>
                                    </div>
                                    <div class="wt-post-info">
                                        <div class="wt-post-meta ">
                                            <ul>
