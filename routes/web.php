...
Route::middleware(['web'])->group(function (){
    ...
    Route::post('/loginCompany', [AuthController::class, 'LoginCompany']);
...
Route::middleware(['auth:user'])->group(function () {
    ...
    Route::get('/detailJob/{id}', [ControllerJob::class, 'detailJob'])->name('detailJob');
    Route::get('/jobByUser/{id}', [ControllerJob::class, 'jobByUser']);
    Route::get('/resume/{id}', [ControllerJob::class, 'resumeUser']);


    // CV Menu
    Route::get('/cv', [AdminController::class, 'cv']);
    Route::get('/organisasi', [AdminController::class, 'organisasi']);
    Route::get('/pendidikan', [AdminController::class, 'pendidikan']);
    Route::get('/soft', [AdminController::class, 'soft']);
    Route::get('/hard', [AdminController::class, 'hard']);
    Route::get('/sertifikasi', [AdminController::class, 'sertifikasi']);
    Route::POST('/addOrganisasi', [AdminController::class, 'addOrganisasi']);
    Route::POST('/addSertifikasi', [AdminController::class, 'addSertifikasi']);
    Route::POST('/addSoft', [AdminController::class, 'addSoftSkill']);
    Route::POST('/addHard', [AdminController::class, 'addHardSkill']);
    Route::POST('/addPendidikan', [AdminController::class, 'addDidik']);
...
Route::middleware(['auth:admin'])->group(function (){
    ...
    Route::get('/download-berkas/{id}', [AdminController::class, 'downloadBerkas'])->name('downloadBerkas');
});
...
Route::middleware(['auth:company'])->group(function () {
    Route::get('/profileCompany/{id}', [CompanyController::class, 'index']);
    Route::get('/joblist/{id}', [CompanyController::class, 'listJobCompany']);
    Route::get('/kandidat', [CompanyController::class, 'kandidat']);
    Route::get('/detailKandidat/{id}', [CompanyController::class, 'detailKandidat']);
    Route::get('/download-berkas/{id}', [AdminController::class, 'downloadBerkas'])->name('downloadBerkas');
    Route::post('/sendEmail/{id}', [CompanyController::class, 'infoInterview']);
    Route::get('/gagal', [CompanyController::class, 'gagal']);
});
